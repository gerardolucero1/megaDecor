...
class InventoryController extends Controller
{
    ...
    public function pdf(Request $request){        
        ...
        if(!is_null($request->familia)){
            $Inventario = Inventory::orderBy('id', 'DESC')->latest()->take(139)->where('familia', $request->familia)->get();
        }else{
        $Inventario = Inventory::orderBy('id', 'DESC')->latest()->take(139)->Where('archivar', null)->orWhere('archivar', false)->get();
             }
