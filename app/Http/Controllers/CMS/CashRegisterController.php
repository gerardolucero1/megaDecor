...
class CashRegisterController extends Controller
{
    ...
    public function pdf($id){
        ...
        $pagos = Payment::with('budget')->orderBy('id', 'DESC')->whereDate('created_at', '>=', $fechaCorte)->whereTime('created_at', '>=', $registro->horaApertura)->whereDate('updated_at', '>=', $fechaCorteCierre)->get();
        $otrosPagos = OtherPayments::orderBy('id', 'DESC')->whereDate('created_at', $fechaCorte)->whereTime('created_at', '>=', $registro->horaApertura)->whereDate('updated_at', '>=', $fechaCorteCierre)->get();
