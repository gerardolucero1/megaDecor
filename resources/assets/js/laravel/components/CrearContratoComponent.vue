                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-10">
                                        ...
                                        <input v-if="presupuesto.pendienteFecha==false" type="date" min="2021-01-22" required v-model="presupuesto.fechaEvento">
                                    </div>
        ...
        <div class="modal fade" id="guardarContrato" tabindex="-1" role="dialog" aria-labelledby="guardarContrato" aria-hidden="true">
            <div id="app" class="modal-dialog modal-lg modal-dialog-centered" role="document">
                ...
                <div class="modal-footer">
                    ...
                    <div v-if="testigoGuardando==0"  class="btn btn-primary" @click="guardarContrato()">Guardar</div>
                </div>
                </div>
            </div>
        </div>
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody v-if="paqueteEdicion.paquete">
                                            <tr v-for="(producto, index) in paqueteEdicion.paquete.inventario" v-bind:key="producto.index">
                                                ...
                                                <td><span v-if="producto.precioFinal!=''">{{ producto.precioFinal }}</span><span v-else>{{producto.precioUnitario*producto.cantidad}}</span></td>
                                                <td class="text-center">
