        ...
        <div class="js-appear-enabled animated fadeIn" data-toggle="appear">  
                            ...
                            <div class="col-6">
                                <div class="form-material">
                                    <input type="text" class="form-control" id="material-gridf" value="0" name="material-gridf">
                                    <label for="material-gridf">Porcentaje Meta De Crecimiento En ventas</label>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-material">
                                    <input type="text" class="form-control" id="material-gridl" value="0" name="material-gridl" >
                        ...
                        <div class="form-group row">
                            <div class="col-6">
                                <div class="form-material">
                                    <input type="text" class="form-control" id="material-gridf" value="1000" name="material-gridf">
                            ...
                            <div class="col-6">
                                <div class="form-material">
                                    <input type="text" class="form-control" id="material-gridl" value="5%" name="material-gridl" >
                                    <label for="material-gridl">Comision general por contrato</label>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-material">
                                    <input type="text" class="form-control" id="material-gridl" value="2000" name="material-gridl" >
