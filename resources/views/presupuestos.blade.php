                    ...
                    <div style="padding:15px; padding-top:30px;">
                     <table  style="font-size: 11px" class="table table-bordered table-striped table-vcenter js-dataTable-full dataTable no-footer" id="TablaPresupuestos" role="grid" >
                            ...
                            <td class="text-center d-none d-sm-table-cell" style="font-size:14px;">
                                    ...
                                    <i onclick="enviarCorreoCliente({{$budget->id}}, '{{$budget->email}}')" class="fa fa-send-o" style="@if($budget->enviado==1) color:green; @else color:#3f9ce8 @endif"  data-toggle="tooltip" @if($budget->enviado==1) title="Presupuesto enviado al cliente"  @else title="Aun no se envia al cliente" @endif></i>             
