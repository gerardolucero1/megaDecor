...
<tr>
  ...
  <td style="text-align: center">{{ (strtolower($ElementoPaquete->cantidad)) }}</td>
  <td></td>
</tr>
@endif 
    @endforeach
...
<p style="font-size: 16px; font-weight: bold; text-align: left"><br>
            ...
            <span style="font-size: 12px; font-weight: normal; text-align: justify">
              --PAGOS CON TARJETA, SERIA MAS IVA DE ACUERDO A LAS NUEVAS DISPOISICIONES FISCALES .
              ==EN CASO DE HACER PAGO EN BANCO O TRASFERENCIA FAVOR DE MANDAR EL COMPROVANTE DE PAGO A SU VENDEDOR PARA PODER HACER EL PAGO EN SISTEMA .
              ==SI EL MOBILIARIO O EL SERVICIO SE RECOGE EN BODEGA ES INDISPENSABLE DEJAR IDENTIFICACION OFICIAL VIGENTE. ESTA SE ENTREGA AL MOMENTO DE REGRESAR LOS SERVICIOS SOLICITADOS.LOS SERVICIOS SE DEBEN ENTREGAR ANTES DE LAS 2 PM PARA NOTENER COSTO ADICIONAL POR DIA DE RENTA.
              ==SI EL SERVICIO SE ENTREGA EN DOMICILIO, ES INDISPENSABLE INDICAR EL LUGAR A DEJAR EL SERVICIO , O BIEN DEJAR A UN ENCARGADO PARA INDICAR EL SITIO A INSTALAR, UNA VEZ INSTALADO EL SERVICIO NO HAY CAMBIOS DE LUGAR DEBIDO A NUESTROS TIEMPOS CON OGTROS CLIENTES. GRACIAS POR SU COMPRENSION.
              ==ESCALERAS O SEGUNDOS PISOS LLEVAN COSTO ADICIONAL.
              == MEGA DECOR NO ASEGURA UN HORARIO ESPECIFICO PARA LA ENTREGA DEL SERVICIO.SIN EMBARGO ESTARA LISTO MINIMO 30 MINUTOS ANTES DE SU EVENTO.
              ==MEGA DECOR CIERRA A LAS 5:00, DESPUES DE ESA HORA CUALQUIER INSTALACION O RECOLECCION TIENE COSTO EXTRA PARA EL CLIENTE.
              ==TODA SALIDA DE BODEGA INCURRE EN PAGO POR PARTE DEL CLIENTE HACIA MEGA DECOR SIN CANCELACIÓN , EN CASO DE QUE ALGUN MOBILIARIO QUE NO QUEDE EN SU DOMICILIO COMO MESAS , CAPRPAS, ETC, NO HAY DEVOLUCION PARCIAL NI TOTAL DEL SERVICIO.
              ==EL EQUIPO DE MEGA DECOR NO MUEVE MOBILILARIO DEL DOMICILIO A INSTALAR. EL AREA DEBE ESTAR DESPEJADO ANTES DE QUE LLEGUE EL CAMION DE MEGA DECOR .
              ==EL CLIENTE SE HACE RESPONSABLE EN SU TOTALIDAD POR DAÑOS QUE PUDIESEN OCASIONRSE EN SU  DIRECCION DEL EVENTO YA SE HACEINDO LA REPOSICION TOTAL DEL MISMO O LA REPARACION SI HACI LO PERMITIESE.
              == EN EVENTOS FUERA DE LA CIUDAD , SE ANEXAN VIATICOS , HOSPEDAJE, CASETAS Y DEMAS CONCEPTOS QUE PERMITAN PODER LLEGAR Y REALIZAR EL SERIVICIO SOLICITADO. 
              == SEGUNDOS DIAS DE SERVICIO SE HACE SOLO UN COBRO DEL 50% DEL TOTAL DEL PRIMER DIA DE RENTA.
              </span><br></p>
              <p style="font-size: 16px; font-weight: bold; text-align: left"><br>
                OBSERVACIONES: <br>
                <span style="font-size: 12px; font-weight: normal; text-align: justify">
                  **PAGOS EN EFECTIVO. EN CASO DE REALIZAR TRASFERENCIA O 
                  **CLIENTES CON CREDITO.- 4% INTERESES DIARIOS POR PAGO TARDIO.
                  **LOS EVENTOS TIENEN QUE SER PAGADOS EN SU TOTALIDAD MINIMO 3 DIAS HABILES Y EN CASO DE BODAS, XV AÑOS, 3 SEMANAS ANTES. DEL EVENTO 
                  ...
                  **LOS SERVICIOS SOLICITADOS SE ENTREGAN EN LUGARES CERCANOS DENTRO DE LA DIRECCION DE ENVIO. EN CASO DE ESCALERAS, LUGARES LEJANOS, PASILLOS ANGOSTOS O PISOS SUBSECUENTES A PLATA BAJA, TIENEN UN COSTO ADICIONAL QUE DEBERA SER PAGADO ANTES DE SU INSTALACION EN NUESTRAS OFICINAS.
                  == SI EL CLIENTE DECIDE LLEVARSE EL MOBILIARIO DESDE BODEGA ES RESPONSABILIDAD TOTAL POR DAÑOS Y/O FALTANTES Y SE DEBE REGRESAR EL MISMO AL SIGUIENTE DIA HABIL ANTES DE LAS 3 PM
                  == EN EVENTOS FUERA DE LA CD SI EL CLIENTE DECIDE LLEVARSE EL MOBILIARIO Y ESTE ES AUTORIZADO POR LA EMPRESA , EL MOBILIARIO DEBE IR ASEGURADO POR EL CLIENTE A NOMBRE DE IVONNE DEL CARMEN ARROYOS PIÑON.
                  ...
                  **EN CASO DE FENOMENOS METEOROLOGICOS, NO HAY CANCELACIONES Y EL CLIENTE SE RESPONSABILIZA POR DAÑOS AL MOBILIARIO YA QUE LOS SERVICIOS SOLICITADOS SE  ENCUENTRAN EN SU POSESIÓN.
                  ==EN CASO DE CONTINGENCIAS. SANITARIAS NACIONALES , LOS EVENTOS SE REPROGRAMAN , NO HAY CANCELACIONES, NI DEVOLUCION DE DINERO,
                  ==EL MOBILIARIO NO SE PUEDE MOVER  POR PARTE DEL CLIENTE A OTRA DIRECCION DONDE SE HAYA DEJADO INICIALMENTE.
                  ==EN EVENTOS GENERALES SE DEJA UN DEPOSITO DE $500.00 MINIMO DEPENDIENDO EL TIPO DE EVENTO PESOS PARA REPOSICIONES O DAÑOS. ESTE PUEDE VARIAR DE ACUERDO AL TIPO DE EVENTO. SE ESPECIFICARA EN LOS SERVICIOS DE SU CONTRATO.
                  </span><br></p>
                  ...
                  <p style="font-size: 16px; font-weight: bold; text-align: left"><br>
                    ...
                    <span style="font-size: 12px; font-weight: normal; text-align: justify">
                      ==NO SE MOVERÁN MUEBLES U OBJETOS DE LA CASA O LOCACIÓN PARA LA ENTREGA DEL MOBILIARIO.
                      </span><br></p>
                      <p style="font-size: 16px; font-weight: bold; text-align: left"><br>
                        OBSERVACIONES: <br>
                        <span style="font-size: 12px; font-weight: normal; text-align: justify">
                          --EL MOBILIARIO ES RENTADO POR 1 DÍA ESTOS SE RECOGEN AL DÍA HÁBIL SIGUIENTE O EN CASO DE SER DOMINGO SE LE NOTIFICARÁ LA HORA DE LA RECOGIDA EN SU DOMICILIO.
                          ==EL MOBILIARIO  NO SE PUEDE MOVER A OTROS DOMICILIOS.
                          ==MONTAJES TIENE UN COSTO ADICIONAL DEPENDIENDO DE LA CANTIDAD A INSTALAR. SE DEBE SOLICITAR PREVIO AL MISMO EN OFICINAS.
                          ==EN CASO DE LLUVIA O NIEVE ,EL MOVILIARIO  DEBERÁN SER MOVIDAS POR EL CLIENTE PARA QUE NO SE DAÑEN. 
                          ==LA SALA SE DEBERÁ ENTREGAR EN PERFECTAS CONDICIONES. EN CASO DE ROTURA O MANCHAS EL ARREGLO O PREPOSICIÓN CORRERÁ POR PARTE DEL CONTRATANTE.
                          == LA SALA SE ENTREGA EN JARDÍN CERCANO NO CONTEMPLANDO ESCALERAS. EN CASO DE HABER ESCALERAS ESTE TENDRÁ UN COSTO ADICIONAL EN CUAL DEBERÁ PAGARSE ANTES DE LLEVARSE. EN CASO DE QUE NO SE NOTIFICARA. SE PAGARA LA DIFERENCIA AL MOMENTO DE LA ENTREGA PARA PODERSE INSTALAR.
                          ==MEGA MUNDO NOTIFICARA EN EL LUGAR DEL EVENTO SI EL MOBILIARIO ESTA DAÑADO O FALTANTES CON FIRMA. 
                        </span><br></p>

                        <p style="font-size: 16px; font-weight: bold; text-align: left"><br>
                          ILUMINACION / DJ / PISTAS LED/ PANTALLAS LED / ROCKOLA<br>
                          <span style="font-size: 12px; font-weight: normal; text-align: justify">
                            --CONECCIONES ELECTRICAS. CERCANAS
                            EN CASO DE NOS ER ASI FAVOR DE SOLICITAR PLANTA DE LUZ CON  COSTO ADICIONAL.
                            --EN CASO DE PISTAS LED TIENE QUE SER EN LUGAR TECHADO.
                            --EN CASO DE DJ Y EPOCAS DE LLUVIA SE SOLICITA LUGAR TECHADO
                          </span><br></p>
                            <p style="font-size: 16px; font-weight: bold; text-align: left"><br>
                              OBSERVACIONES: <br>
                              <span style="font-size: 12px; font-weight: normal; text-align: justify">
                                DE ACUERDO AL SERVICIO CONTRATADO EN SU HOJA DE SERVICIOS:
PISTA LED.. SERVICIO POR DIA.
DJ-- SERVICIO  POR 5 HORAS.
         PUEDE PROPORCIONARNOS CON 5 DIAS DE ANTICIPACION ALGUNA 
         CANCION EN ESPECIAL, ARTISTAS , GRUPOS, MDESANJES QUE SE 
         DESEEN QUE SE MENCIONEN QUE DESEEN QUE SE  TOQUEN.
ILUMIACION GENERAL ADICIONAL-- COSTO POR DIA.
PANTALLAS LED--SERVICIO 5 HORAS.</span><br></p>
<br>
