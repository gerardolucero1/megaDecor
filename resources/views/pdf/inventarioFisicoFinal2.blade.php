...
@endphp
<p>Inventario Impreso {{$fechaHoy}} <span style="font-weight: bold">@if($faltantes=='si') Faltantes @else Inventario Final @endif</span></p>
<table style="border-width: 1px; width:100%; text-align:center">
    <tr style=" font-size: 12px">
      ...
      <th style="padding: 4px;">Antes Bodega</th>
       ...
       <th style="padding: 4px;">Diferencia Bodega</th>
       <th style="padding: 4px;">Antes Exhibición</th>
       <th style="padding: 4px;">Fisico Exhibición</th>
       <th style="padding: 4px;">Diferencia General</th>
       <th style="padding: 4px;">Dif. General</th>
