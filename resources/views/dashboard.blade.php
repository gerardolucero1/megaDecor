...
@if($permisos->dashboardComponenteVentas==1)
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                                ...
                                <div id='calendar2' style="position:absolute; z-index:1; background:white; @if ($usuario == 2 && $usuario==6) display:none; @endif padding:15px; margin-left:-20px; width:100%"></div>
