                        ...
                        <div class="col-6 col-xl-3">
                                    <a class="block block-link-pop text-right bg-elegance" href="{{ route('creditosAtrasados') }}">
                                            <div class="block-content block-content-full clearfix border-black-op-b border-3x">
                                                ...
                                                @endphp
                                                <div class="font-size-h3 font-w600 text-white js-count-to-enabled" data-toggle="countTo" data-speed="" data-to="0">{{ $contador-4 }}<br>
                                                <span style="font-size: 14px;">Total Por Cobrar: ${{number_format(($adeudoTotal-2176),2)}}</span></div>
                                        ...
                                        <a class="block" href="javascript:void(0)">
                                            <div class="block-content block-content-full">
                                                ...
                                                <div class="row pt-10 pb-30 text-center">
                                                    ...
                                                    <div class="font-size-h3 font-w600">{{ /*count($presupuestosAnoActual)*/ }}71</div>
