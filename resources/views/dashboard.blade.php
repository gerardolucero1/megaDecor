                        ...
                        <div class="col-6 col-xl-3">
                                    <a class="block block-link-pop text-right bg-elegance" href="{{ route('creditosAtrasados') }}">
                                            <div class="block-content block-content-full clearfix border-black-op-b border-3x">
                                                ...
                                                @endphp
                                                <div class="font-size-h3 font-w600 text-white js-count-to-enabled" data-toggle="countTo" data-speed="" data-to="0"><!--{{ $numCreditos }}--> 15<br>
                                                <span style="font-size: 14px;">Total Por Cobrar: $<!--{{number_format($adeudoTotal,2)}}-->119,190.00</span></div>
