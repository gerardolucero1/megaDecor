...
@endif
        ...
        <div class="block">
            <div class="block-header block-header-default">
                    <a href="{{ route('faltantes.create')}}" class="btn btn-sm btn-primary">Agregar faltantes</a>
            </div>
            <div class="row">
                            ...
                            @foreach ($faltantes as $faltante)
                                <tr role="row" class="odd">
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('faltantes.edit', $faltante->id) }}" class="btn btn-sm btn-info">Editar</a>
                                    </td>
                                    <td class="text-center">
                                            <form action="{{route('faltantes.destroy', $faltante->id)}}" method="POST">
                                            {{ csrf_field() }}
                                    ...
                                    <td class="text-center">                                                                               
                                        <a href="{{ route('faltantes.show', $faltante->id) }}" class="btn btn-sm btn-info">Cliente</a>
                                    </td>
                                    <td class="text-center">                                                                               
                                        <a href="{{ route('faltantes.show', $faltante->id_article) }}" class="btn btn-sm btn-info">Articulo</a>
                                    </td>
                                </tr>
                            @endforeach                                     
                        </tbody>
