...
Route::group(['middleware' => ['cors']], function () {
    ...
    Route::get('/obtener-presupuesto-folio/{id}', 'CMS\BudgetController@obtenerPresupuestoFolio');
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::post('/imprimir-familiapt3', 'CMS\InventoryController@pdfpt3')->name('imprimir.familiapt3');
    ...
    Route::get('enviar-email-cliente/{id}', function ($id) {
        ...
        Mail::to('ivonnearroyosdecor@hotmail.com', 'Presupuesto MegaMundo')
            ->send(new NuevoPresupuesto($presupuesto, $Telefonos, $Elementos, $Paquetes, $arregloEmentos));
    });
    ...
    Route::get('obtener-detalles', function () {
        ...
        foreach ($pagos as $pago) {
            ...
            $datosPago->created_at = ($pago->created_at)->format('Y-m-d H:m');
